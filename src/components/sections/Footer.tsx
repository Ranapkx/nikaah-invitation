...
export default function Footer() {
  const handleWhatsAppShare = () => {
    const text = encodeURIComponent(
      "You're invited to the Nikah ceremony of Jaseem & Haifa! 💍\n\n" +
      "📅 January 31, 2026\n" +
    ...
    <footer className={styles.footer}>
      ...
      >
        <div className={styles.footerNames}>
          <span className={styles.footerNameArabic}>جاسيم</span>
          <span className={styles.footerAmpersand}>&</span>
          <span className={styles.footerNameArabic}>حيفاء</span>
        </div>
        ...
        <p className={styles.footerDate}>January 31, 2026</p>
      </motion.div>
    </footer>
  )
}
